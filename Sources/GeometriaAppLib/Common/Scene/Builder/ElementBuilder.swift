...
struct ElementBuilder {
    ...
    @inlinable
    static func buildExpression(_ value: RCube3D) -> CubeElement {
        .init(geometry: value, material: 0)
    }
    @inlinable
    static func buildExpression(_ value: (RCube3D, Int)) -> CubeElement {
        .init(geometry: value.0, material: value.1)
    }
    @inlinable
    static func buildExpression<T: RawRepresentable>(_ value: (RCube3D, T)) -> CubeElement where T.RawValue == Int {
        .init(geometry: value.0, material: value.1.rawValue)
    }
