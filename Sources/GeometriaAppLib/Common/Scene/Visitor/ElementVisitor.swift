...
borrowing 
    ...
    */
    ...
    func visit<T0, T1>(_ element: borrowing TupleElement2<T0, T1>) -> ResultType
    func visit<T0, T1>(_ element: borrowing BoundedTupleElement2<T0, T1>) -> ResultType
    
    func visit<T0, T1, T2>(_ element: borrowing TupleElement3<T0, T1, T2>) -> ResultType
    func visit<T0, T1, T2>(_ element: borrowing BoundedTupleElement3<T0, T1, T2>) -> ResultType
    
    func visit<T0, T1, T2, T3>(_ element: borrowing TupleElement4<T0, T1, T2, T3>) -> ResultType
    func visit<T0, T1, T2, T3>(_ element: borrowing BoundedTupleElement4<T0, T1, T2, T3>) -> ResultType

    func visit<T0, T1, T2, T3, T4>(_ element: borrowing TupleElement5<T0, T1, T2, T3, T4>) -> ResultType
    func visit<T0, T1, T2, T3, T4>(_ element: borrowing BoundedTupleElement5<T0, T1, T2, T3, T4>) -> ResultType
    
    func visit<T0, T1, T2, T3, T4, T5>(_ element: borrowing TupleElement6<T0, T1, T2, T3, T4, T5>) -> ResultType
    func visit<T0, T1, T2, T3, T4, T5>(_ element: borrowing BoundedTupleElement6<T0, T1, T2, T3, T4, T5>) -> ResultType
    
    func visit<T0, T1, T2, T3, T4, T5, T6>(_ element: borrowing TupleElement7<T0, T1, T2, T3, T4, T5, T6>) -> ResultType
    func visit<T0, T1, T2, T3, T4, T5, T6>(_ element: borrowing BoundedTupleElement7<T0, T1, T2, T3, T4, T5, T6>) -> ResultType
    
    func visit<T0, T1, T2, T3, T4, T5, T6, T7>(_ element: borrowing TupleElement8<T0, T1, T2, T3, T4, T5, T6, T7>) -> ResultType
    func visit<T0, T1, T2, T3, T4, T5, T6, T7>(_ element: borrowing BoundedTupleElement8<T0, T1, T2, T3, T4, T5, T6, T7>) -> ResultType
}
