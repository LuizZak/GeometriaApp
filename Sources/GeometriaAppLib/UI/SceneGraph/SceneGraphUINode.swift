...
final class SceneGraphUINode {
    ...
    */
    ...
    func addingSubNodes<Base: Element, Value: Element>(_ visitor: SceneGraphVisitor, mutating element: Base, _ keyPath: WritableKeyPath<Base, [Value]>) -> SceneGraphUINode {
        var result = self
