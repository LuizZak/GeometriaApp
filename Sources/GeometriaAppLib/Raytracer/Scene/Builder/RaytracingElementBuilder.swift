...
struct RaytracingElementBuilder {
    ...
    static func buildBlock<T0, T1, T2>(
        ...
        _ t1: T1,
        _ t2: T2
    ) -> TupleRaytracingElement3<T0, T1, T2> {
    ...
    static func buildBlock<T0, T1, T2, T3>(
        ...
        _ t2: T2,
        _ t3: T3
    ) -> TupleRaytracingElement4<T0, T1, T2, T3> {
    ...
    static func buildBlock<T0, T1, T2, T3, T4>(
        ...
        _ t3: T3,
        _ t4: T4
    ) -> TupleRaytracingElement5<T0, T1, T2, T3, T4> {
    ...
    static func buildBlock<T0, T1, T2, T3, T4, T5>(
        ...
        _ t4: T4,
        _ t5: T5
    ) -> TupleRaytracingElement6<T0, T1, T2, T3, T4, T5> {
    ...
    static func buildBlock<T0, T1, T2, T3, T4, T5, T6>(
        ...
        _ t5: T5,
        _ t6: T6
    ) -> TupleRaytracingElement7<T0, T1, T2, T3, T4, T5, T6> {
    ...
    static func buildBlock<T0, T1, T2, T3, T4, T5, T6, T7>(
        ...
        _ t6: T6,
        _ t7: T7
    ) -> TupleRaytracingElement8<T0, T1, T2, T3, T4, T5, T6, T7> {
