...
public struct SmoothIntersectionElement<T0: RaymarchingElement, T1: RaymarchingElement>: RaymarchingElement {
    public var id: Int = 0
    public var t0: T0
    public var t1: T1
...
extension SmoothIntersectionElement: Element {
...
@_transparent
public func intersection<T0, T1>(smoothSize: Double, @RaymarchingElementBuilder _ builder: () -> TupleRaymarchingElement2<T0, T1>) -> SmoothIntersectionElement<T0, T1> {
    let value = builder()
