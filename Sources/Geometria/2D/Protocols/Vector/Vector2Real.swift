...
public protocol Vector2Real: Vector2FloatingPoint & VectorReal {
    ...
    func rotatedBy(_ angleInRadians: Scalar) -> Self
    
    /// Rotates this vector around the origin by a given angle in radians
    mutating func rotateBy(_ angleInRadians: Scalar)
    
    /// Rotates this vector around a given pivot by a given angle in radians
    func rotatedBy(_ angleInRadians: Scalar, around pivot: Self) -> Self
    ...
    @inlinable
    static func * (lhs: Self, rhs: Matrix3x2) -> Self
    
    @inlinable
    static func *= (lhs: inout Self, rhs: Matrix3x2)
}
