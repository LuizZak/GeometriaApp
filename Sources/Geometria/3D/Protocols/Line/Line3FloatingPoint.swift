...
public extension Line3FloatingPoint {
    @inlinable
    @_specialize(exported: true, kind: full, where Self == LineSegment3D, Line == LineSegment3D)
    @_specialize(exported: true, kind: full, where Self == DirectionalRay3D, Line == DirectionalRay3D)
