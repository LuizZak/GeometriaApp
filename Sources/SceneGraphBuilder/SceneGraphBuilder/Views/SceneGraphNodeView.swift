...
class SceneGraphNodeView: RootView {
    ...
    private class InputView: View {
        ...
        func reloadDisplay() {
            ...
            if !input.required {
                connectionView.tooltip = formatTooltip("\(symbol: input.name): \(dataType: input.type) \(muted: "optional")")
            } else {
                connectionView.tooltip = formatTooltip("\(symbol: input.name): \(dataType: input.type)")
            }
        }
    }
    ...
    private class OutputView: View {
        ...
        func reloadDisplay() {
            ...
            connectionView.tooltip = formatTooltip("\(symbol: output.name): \(dataType: output.type)")
        }
    }
